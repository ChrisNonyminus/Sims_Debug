...
// bndchk.h
#ifdef BOUNDS_CHECK
void check_bounds(int index, int container_size, int lineno, char *filename);
#endif
...
template <class charT> struct string_char_baggage {
  ...
  static istream &char_in(istream &is, char_type &c) {
    return is >> c; // extractor for a char_type object
  }
  static ostream &char_out(ostream &os, char_type c) {
    return os << c; // inserter for a char_type object
  }
  static bool is_del(char_type c) {
...
template <class charT> class basic_string_ref {
  ...
  inline void delete_ptr();

  inline static charT eos();

  inline static void throwlength();

  inline static void throwrange();
};
...
private:
  ...
  void assign_str(const charT *s, size_t slen);

  void append_str(const charT *s, size_t slen);

  void insert_str(size_t pos, const charT *s, size_t slen);

  void replace_str(size_t xlen, size_t pos, const charT *s, size_t slen);

  int compare_str(size_t pos, const charT *str, size_t slen,
                  size_t strlen) const;

  size_t find_str(const charT *s, size_t pos, size_t len) const;

  size_t rfind_str(const charT *s, size_t pos, size_t len) const;

  size_t find_first_of_str(const charT *s, size_t pos, size_t len) const;

  size_t find_last_of_str(const charT *s, size_t pos, size_t len) const;

  size_t find_first_not_of_str(const charT *s, size_t pos, size_t len) const;

  size_t find_last_not_of_str(const charT *s, size_t pos, size_t len) const;

protected:
  basic_string(const charT *s, size_t rlen, size_t xlen);

  inline void delete_ref();
...
public:
  ...
  basic_string<charT> &append(const basic_string<charT> &str, size_t pos = 0,
                              size_t n = NPOS);
  ...
  basic_string<charT> &append(charT c, size_t rep = 1);

  basic_string<charT> &assign(const basic_string<charT> &str, size_t pos = 0,
                              size_t n = NPOS);
  ...
  basic_string<charT> &assign(charT c, size_t rep = 1);
  ...
  basic_string<charT> &insert(size_t pos, charT c, size_t rep = 1);

  basic_string<charT> &remove(size_t pos = 0, size_t n = NPOS);

  basic_string<charT> &replace(size_t pos1, size_t n1,
                               const basic_string<charT> &str, size_t pos2 = 0,
                               size_t n2 = NPOS);
  ...
  basic_string<charT> &replace(size_t pos, size_t n, charT c, size_t rep = 1);
  ...
  size_t find(const basic_string<charT> &str, size_t pos = 0) const;
  ...
  size_t rfind(const basic_string<charT> &str, size_t pos = NPOS) const;
  ...
  size_t find_first_of(const basic_string<charT> &str, size_t pos = 0) const;
  ...
  size_t find_last_of(const basic_string<charT> &str, size_t pos = NPOS) const;
  ...
  size_t find_first_not_of(const basic_string<charT> &str,
                           size_t pos = 0) const;
  ...
  size_t find_last_not_of(const basic_string<charT> &str,
  ...
  basic_string<charT> substr(size_t pos = 0, size_t n = NPOS) const;

  int compare(const basic_string<charT> &str, size_t pos = 0,
              size_t n = NPOS) const;
  ...
  friend ostream &operator<<(ostream &o, const basic_string<charT> &s);

  friend istream &operator>>(istream &i, basic_string<charT> &s);

  friend basic_string<charT> operator+(const basic_string<charT> &lhs,
                                       const basic_string<charT> &rhs);

  friend basic_string<charT> operator+(const charT *lhs,
                                       const basic_string<charT> &rhs);

  friend basic_string<charT> operator+(charT lhs,
                                       const basic_string<charT> &rhs);
...
template <class charT> inline void basic_string_ref<charT>::delete_ptr() {
  if (res) {
    delete[] ptr;
    res = 0;
    ptr = 0;
...
template <class charT> inline void basic_string_ref<charT>::throwlength() {
#ifdef __MEXCEPT
...
template <class charT> inline void basic_string_ref<charT>::throwrange() {
#ifdef __MEXCEPT
...
template <class charT> inline void basic_string<charT>::delete_ref() {
  --(reference->count);
  if (!(reference->count))
    delete reference;
}

template <class charT> inline size_t basic_string<charT>::ref_count() const {
  return reference->count;
}

template <class charT> inline const charT *basic_string<charT>::data() const {
  if (length())
...
template <class charT> inline charT *basic_string<charT>::point() {
  return reference->ptr;
}

template <class charT> inline size_t &basic_string<charT>::len() {
  return reference->len;
}

template <class charT> inline size_t basic_string<charT>::length() const {
  return reference->len;
}

template <class charT> inline size_t basic_string<charT>::reserve() const {
  return reference->res;
}

template <class charT>
inline charT basic_string<charT>::get_at(size_t pos) const {
  if (pos >= length()) {
...
template <class charT>
inline charT basic_string<charT>::operator[](size_t pos) const {
  if (pos < length())
    return *(data() + pos);
  else
    return 0;
...
template <class charT>
inline bool operator==(const basic_string<charT> &lhs,
                       const basic_string<charT> &rhs)
...
template <class charT>
inline bool operator==(charT lhs, const basic_string<charT> &rhs) {
  return !(rhs.compare(lhs));
}
...
template <class charT>
inline bool operator==(const basic_string<charT> &lhs, charT rhs) {
  return !(lhs.compare(rhs));
}
...
template <class charT> charT basic_string_ref<charT>::eos() {
  return baggage_type::eos();
}

template <class charT> basic_string_ref<charT>::basic_string_ref() {
  res = len = 0;
  ptr = 0;
  count = 1;
}
...
template <class charT> charT basic_string<charT>::eos() {
  return baggage_type::eos();
}

template <class charT>
void basic_string<charT>::assign_str(const charT *s, size_t slen)
...
template <class charT>
void basic_string<charT>::append_str(const charT *s, size_t slen)
...
template <class charT>
void basic_string<charT>::insert_str(size_t pos, const charT *s, size_t slen)
...
template <class charT>
void basic_string<charT>::replace_str(size_t xlen, size_t pos, const charT *s,
                                      size_t slen) {
  if (pos > length()) {
    reference_class::throwrange();
  }
...
template <class charT>
int basic_string<charT>::compare_str(size_t pos, const charT *str, size_t slen,
                                     size_t strlen) const {
  if (pos > length()) {
    reference_class::throwrange();
  }
...
template <class charT>
size_t basic_string<charT>::find_str(const charT *s, size_t pos,
                                     size_t len) const {
  size_t count = pos;
  size_t shift;
  size_t place;
...
template <class charT>
size_t basic_string<charT>::rfind_str(const charT *s, size_t pos,
                                      size_t len) const {
...
template <class charT>
size_t basic_string<charT>::find_first_of_str(const charT *s, size_t pos,
                                              size_t len) const {
  size_t temp;
  size_t count = pos;
  size_t result = NPOS;
...
template <class charT>
size_t basic_string<charT>::find_last_of_str(const charT *s, size_t pos,
                                             size_t len) const {
  size_t temp = 0;
...
template <class charT>
size_t basic_string<charT>::find_first_not_of_str(const charT *s, size_t pos,
                                                  size_t len) const {
  size_t count = pos;
  while (count < length()) {
    size_t temp = 0;
...
template <class charT>
size_t basic_string<charT>::find_last_not_of_str(const charT *s, size_t pos,
                                                 size_t len) const {
  size_t temp = 0;
  size_t count = (pos < length()) ? (pos + 1) : length();
...
template <class charT> basic_string<charT>::basic_string() {
...
template <class charT>
basic_string<charT>::basic_string(const basic_string<charT> &str, size_t pos,
                                  size_t n) {
  if (pos > str.length()) {
    reference_class::throwrange();
  }
...
template <class charT> basic_string<charT>::basic_string(const charT *s) {
  reference = new basic_string_ref<charT>(s);
  c_str_ptr = 0;
}

template <class charT> basic_string<charT>::basic_string(charT c, size_t rep) {
...

{
  ...
  append_str(str.data() + pos,
             (n > (str.length() - pos)) ? (str.length() - pos) : n);
  return *this;
}

template <class charT>
basic_string<charT> &basic_string<charT>::append(const charT *s, size_t n) {
  append_str(s, n);
  return *this;
}
...
template <class charT>
basic_string<charT> &basic_string<charT>::append(charT c, size_t rep) {
  if (length() >= (NPOS - rep)) {
    reference_class::throwlength();
  }
  if (rep) {
...
template <class charT>
basic_string<charT> &basic_string<charT>::assign(const charT *s, size_t n) {
  assign_str(s, n);
  return *this;
}
...
template <class charT>
basic_string<charT> &basic_string<charT>::assign(charT c, size_t rep) {
  if (rep == NPOS) {
    reference_class::throwlength();
  }
...
template <class charT>
basic_string<charT> &basic_string<charT>::insert(size_t pos, const charT *s,
                                                 size_t n)
...
template <class charT>
basic_string<charT> &basic_string<charT>::insert(size_t pos, charT c,
                                                 size_t rep)
...
template <class charT>
basic_string<charT> &basic_string<charT>::remove(size_t pos, size_t n) {
  if (pos > length()) {
    reference_class::throwrange();
  }
  ...
  if (ref_count() > 1) {
    ...
    baggage_type::copy(tmp->ptr + pos, data() + pos + xlen,
                       length() - xlen - pos);
    tmp->len = length() - xlen;
    delete_ref();
    reference = tmp;
    ...
    baggage_type::copy(point() + pos, data() + pos + xlen,
                       length() - xlen - pos);
    reference->len -= xlen;
  }
  return *this;
...
basic_string<charT> &
basic_string<charT>::replace(size_t pos1, size_t n1,
                             const basic_string<charT> &str, size_t pos2,
                             size_t n2) {
  if (pos2 > str.length()) {
    reference_class::throwrange();
  }
...
template <class charT>
basic_string<charT> &basic_string<charT>::replace(size_t pos, size_t n1,
...
template <class charT>
basic_string<charT> &basic_string<charT>::replace(size_t pos, size_t n, charT c,
                                                  size_t rep)

{
  ...
  if (!rep)
    ...
    if ((ref_count() > 1) || (reserve() < (length() - xlen + rep))) {
      reference_pointer tmp;
      tmp = new basic_string_ref<charT>(
          data(), pos, length() + ((xlen > rep) ? (xlen - rep) : 0));
      if (rep < xlen)
...
template <class charT> void basic_string<charT>::put_at(size_t pos, charT c) {
  if (pos > length()) {
    reference_class::throwrange();
  }
...
template <class charT> charT &basic_string<charT>::operator[](size_t pos) {
  if (pos >= length()) {
    reference_class::throwrange();
  }
  if (ref_count() > 1) {
...
template <class charT> const charT *basic_string<charT>::c_str() const {
  if (c_str_ptr)
...
template <class charT> void basic_string<charT>::resize(size_t n, charT c) {
  if (n == NPOS) {
    reference_class::throwlength();
  }
  if ((ref_count() > 1) || (n > reserve())) {
    reference_pointer tmp;
    tmp =
        new basic_string_ref<charT>(data(), ((n > length()) ? length() : n), n);
    delete_ref();
    reference = tmp;
  }
...
template <class charT> void basic_string<charT>::resize(size_t n) {
  resize(n, eos());
}

template <class charT> void basic_string<charT>::reserve(size_t res_arg) {
  if (res_arg == NPOS) {
    reference_class::throwlength();
  }
  if (res_arg > reserve()) {
...
template <class charT>
size_t basic_string<charT>::copy(charT *s, size_t n, size_t pos) const {
  if (pos > length()) {
    reference_class::throwrange();
  }
...
template <class charT>
size_t basic_string<charT>::find(const charT *s, size_t pos, size_t n) const
...
template <class charT>
size_t basic_string<charT>::find(const charT *s, size_t pos) const {
  return find_str(s, pos, baggage_type::length(s));
}

template <class charT>
size_t basic_string<charT>::find(charT c, size_t pos) const {
...
template <class charT>
size_t basic_string<charT>::rfind(const charT *s, size_t pos, size_t n) const
...
template <class charT>
size_t basic_string<charT>::rfind(const charT *s, size_t pos) const {
  return rfind_str(s, pos, baggage_type::length(s));
}

template <class charT>
size_t basic_string<charT>::rfind(charT c, size_t pos) const {
  size_t count = ((pos < length()) ? pos + 1 : length());
  if (length() == 0)
    return NPOS;
...
template <class charT>
size_t basic_string<charT>::find_first_of(const charT *s, size_t pos,
                                          size_t n) const
...
template <class charT>
size_t basic_string<charT>::find_first_of(const charT *s, size_t pos) const
...
template <class charT>
size_t basic_string<charT>::find_first_of(charT c, size_t pos) const {
  return find(c, pos);
}
...
template <class charT>
size_t basic_string<charT>::find_last_of(const charT *s, size_t pos,
                                         size_t n) const
...
template <class charT>
size_t basic_string<charT>::find_last_of(const charT *s, size_t pos) const {
  return find_last_of_str(s, pos, baggage_type::length(s));
}

template <class charT>
size_t basic_string<charT>::find_last_of(charT c, size_t pos) const {
  return rfind(c, pos);
}
...
template <class charT>
size_t basic_string<charT>::find_first_not_of(const charT *s, size_t pos,
                                              size_t n) const {
  return find_first_not_of_str(s, pos, n);
}

template <class charT>
size_t basic_string<charT>::find_first_not_of(const charT *s, size_t pos) const
...
template <class charT>
size_t basic_string<charT>::find_first_not_of(charT c, size_t pos) const {
...
template <class charT>
size_t basic_string<charT>::find_last_not_of(const charT *s, size_t pos,
                                             size_t n) const {
  return find_last_not_of_str(s, pos, n);
}

template <class charT>
size_t basic_string<charT>::find_last_not_of(const charT *s, size_t pos) const
...
template <class charT>
size_t basic_string<charT>::find_last_not_of(charT c, size_t pos) const {
  size_t count = ((pos < length()) ? pos + 1 : length());
  if (length() == 0)
    return NPOS;
...
template <class charT>
basic_string<charT> basic_string<charT>::substr(size_t pos, size_t n) const {
  if (pos > length()) {
    reference_class::throwrange();
  }
  if (length())
...
template <class charT>
int basic_string<charT>::compare(const basic_string<charT> &str, size_t pos,
                                 size_t n) const {
...
template <class charT>
int basic_string<charT>::compare(const charT *s, size_t pos, size_t n) const
...
template <class charT>
int basic_string<charT>::compare(const charT *s, size_t pos) const {
  return compare_str(pos, s, length() - pos, baggage_type::length(s));
}

template <class charT>
int basic_string<charT>::compare(charT c, size_t pos, size_t rep) const
...
basic_string<charT> operator+(const basic_string<charT> &lhs,
  ...
  if (rhs.length())
#ifdef __CINT__
    basic_string<charT>::baggage_type::copy(tmp.point() + lhs.length(),
                                            rhs.data(), rhs.length());
#else
...
basic_string<charT> operator+(const charT *lhs,
  ...
  if (rhs.length())
#ifdef __CINT__
    basic_string<charT>::baggage_type::copy(tmp.point() + slen, rhs.data(),
                                            rhs.length());
#else
...
basic_string<charT> operator+(charT lhs, const basic_string<charT> &rhs) {
  ...
  if (rhs.length())
#ifdef __CINT__
    basic_string<charT>::baggage_type::copy(tmp.point() + 1, rhs.data(),
                                            rhs.length());
#else
...
basic_string<charT> operator+(const basic_string<charT> &lhs,
  ...
  if (slen)
#ifdef __CINT__
    basic_string<charT>::baggage_type::copy(tmp.point() + lhs.length(), rhs,
                                            slen);
#else
...
template <class charT>
ostream &operator<<(ostream &o, const basic_string<charT> &s) {
#ifndef __CINT__
  typedef basic_string<charT>::baggage_type baggage_type;
#endif
...
template <class charT> istream &operator>>(istream &i, basic_string<charT> &s) {
#ifndef __CINT__
  typedef basic_string<charT>::baggage_type baggage_type;
#endif
  s.remove();
